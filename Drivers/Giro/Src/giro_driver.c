...
int giro_read_angls(I2C_HandleTypeDef* hi2, double* angle_x, double* angle_y, double* angle_z)
{
      ...
      ////////
      *angle_x = Gyro_X_RAW*(500*3.1415/(65535*180));
      *angle_y = Gyro_Y_RAW*(250*3.1415/(32767*180));
      *angle_z = Gyro_Z_RAW*(250*3.1415/(32767*180));
      
      if((*angle_x < FILTR) && (*angle_x > -FILTR)) *angle_x = 0;
      if((*angle_y < FILTR) && (*angle_y > -FILTR)) *angle_y = 0;
      if((*angle_z < FILTR) && (*angle_z > -FILTR)) *angle_z = 0;
